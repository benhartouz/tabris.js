...
interface AlertDialogEvents extends PopupEvents {
   ...
   */
  onTextInputsChanged?: (event: tabris.PropertyChangedEvent<tabris.AlertDialog, tabris.TextInput[]>) => void;
...
interface PopoverEvents extends PopupEvents {
   ...
   */
  onClose?: (event: tabris.EventObject<tabris.Popover>) => void;

  /**
   * Fired when the [*anchor*](#anchor) property has changed.
   * @param value The new value of [*anchor*](#anchor).
   */
  onAnchorChanged?: (event: tabris.PropertyChangedEvent<tabris.Popover, tabris.Widget>) => void;

  /**
   * Fired when the [*height*](#height) property has changed.
   * @param value The new value of [*height*](#height).
   */
  onHeightChanged?: (event: tabris.PropertyChangedEvent<tabris.Popover, tabris.dimension>) => void;

  /**
   * Fired when the [*width*](#width) property has changed.
   * @param value The new value of [*width*](#width).
   */
  onWidthChanged?: (event: tabris.PropertyChangedEvent<tabris.Popover, tabris.dimension>) => void;
}
...
interface NavigationViewEvents extends CompositeEvents {
   ...
   */
  onNavigationActionChanged?: (event: tabris.PropertyChangedEvent<tabris.NavigationView, tabris.Action>) => void;
...
interface StatusBarEvents extends WidgetEvents {
   ...
   */
  onTap?: (event: tabris.StatusBarTapEvent) => void;
...
interface TextInputEvents extends WidgetEvents {
   ...
   * the tapped position.
   */
  onSelect?: (event: tabris.TextInputSelectEvent) => void;
   ...
   * @param value The new value of [*selection*](#selection).
   */
  onSelectionChanged?: (event: tabris.PropertyChangedEvent<tabris.TextInput, number[]>) => void;
...
interface TextViewEvents extends WidgetEvents {
   ...
   */
  onTapLink?: (event: tabris.TextViewTapLinkEvent) => void;
...
export type PopoverProperties = tabris.PopoverProperties & PopoverEvents;
