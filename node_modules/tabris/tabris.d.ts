...
// Type definitions for Tabris.js 2.6.1
...
interface AlertDialogEvents extends PopupEvents {
   ...
   */
  textInputsChanged?: (event: PropertyChangedEvent<AlertDialog, TextInput[]>) => void;
...
interface _PopoverProperties extends _PopupProperties {
...
type PopoverProperties = Partial<_PopoverProperties>

interface PopoverEvents extends PopupEvents {

  /**
   * Fired when the `Popover` was closed.
   */
  close?: (event: EventObject<Popover>) => void;

  /**
   * Fired when the [*anchor*](#anchor) property has changed.
   * @param value The new value of [*anchor*](#anchor).
   */
  anchorChanged?: (event: PropertyChangedEvent<Popover, Widget>) => void;

  /**
   * Fired when the [*height*](#height) property has changed.
   * @param value The new value of [*height*](#height).
   */
  heightChanged?: (event: PropertyChangedEvent<Popover, dimension>) => void;

  /**
   * Fired when the [*width*](#width) property has changed.
   * @param value The new value of [*width*](#width).
   */
  widthChanged?: (event: PropertyChangedEvent<Popover, dimension>) => void;
}
 ...
 */
interface Popover extends _PopoverProperties {}
 export class Popover extends Popup {
   ...
   * the `Properties` interface. It's value is always undefined.
   */
  public readonly tsProperties: PopoverProperties;
   ...
   * @param listeners A key-value map where the keys are event types and the values are the listeners to deregister from these events, e.g. `{tap: onTap, scroll: onScroll}`.
   */
  off(listeners: PopoverEvents): this;
   ...
   * @param listeners A key-value map where the keys are event types and the values are the listeners to register for these events, e.g. `{tap: onTap, scroll: onScroll}`.
   */
  on(listeners: PopoverEvents): this;
   ...
   * @param listeners A key-value map where the keys are event types and the values are the listeners to register for these events, e.g. `{tap: onTap, scroll: onScroll}`.
   */
  once(listeners: PopoverEvents): this;
}
...
interface Printer extends _PrinterProperties {}
 export class Printer extends NativeObject {
   ...
   */
  print(data: any, options?: {jobName?: string, contentType?: string}): Promise<any>;
}
...
interface NavigationViewEvents extends CompositeEvents {
   ...
   */
  navigationActionChanged?: (event: PropertyChangedEvent<NavigationView, Action>) => void;
...
interface StatusBarEvents extends WidgetEvents {
   ...
   */
  tap?: (event: StatusBarTapEvent) => void;
...
interface StatusBarTapEvent extends EventObject<StatusBar> {
...
interface TextInputEvents extends WidgetEvents {
   ...
   * the tapped position.
   */
  select?: (event: TextInputSelectEvent) => void;
   ...
   * @param value The new value of [*selection*](#selection).
   */
  selectionChanged?: (event: PropertyChangedEvent<TextInput, number[]>) => void;
...
interface TextInputSelectEvent extends EventObject<TextInput> {
  readonly selection: number[];
}
...
interface TextViewEvents extends WidgetEvents {
   ...
   */
  tapLink?: (event: TextViewTapLinkEvent) => void;
...
interface TextViewTapLinkEvent extends EventObject<TextView> {
  readonly url: string;
}
